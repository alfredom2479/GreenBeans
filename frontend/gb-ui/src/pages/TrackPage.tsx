...
export default function TrackPage(){
  ...
  return (
    <div className="flex-1 min-h-[30rem] w-full flex flex-col overflow-hidden">
      <header className="shrink-0 border-b border-zinc-800/80 bg-zinc-900/50 p-4">
        ...
        <div className="flex-1 min-h-0 overflow-y-scroll flex flex-col overflow-hidden px-4 sm:px-6 pb-6">
          <Outlet context={{
